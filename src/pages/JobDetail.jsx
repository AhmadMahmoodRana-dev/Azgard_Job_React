    ...
    <div className="min-h-screen bg-gray-100 p-6 flex justify-center">
      <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            {!showForm ? (
              ...
              >
                <div className="mb-6">
                  ...
                  <ul className="list-disc list-inside space-y-2 text-gray-700 text-sm pl-12">
                    <li>
                      Contact customers via phone, email and letter to identify
                      them & collect outstanding payments.
                    </li>
                    <li>
                      Trace individuals who have skipped on their financial
                      obligations using various research techniques
                    ...
                    <li>
                      ...
                      their current addresses and notify them about illegal use
                      of energy
                    </li>
                    <li>
        ...
        <div>
          <div className="bg-white rounded-xl shadow p-10 flex flex-col justify-between">
            <button
              className="w-full bg-green-700 text-white text-xl py-3 rounded-full font-medium hover:bg-green-800 transition mb-6"
